...
curl -k -u admin:CAdemo123! -H "Content-Type: application/xml" -X POST -d @lac-policy.xml https://34.83.15.101:31843/restman/1.0/services
sleep 10s

echo
echo INFO: Calling the deployed gateway service to proxy to Live API Creator!
curl -k -u admin:CAdemo123! https://34.83.15.101:31843/lac-policy
